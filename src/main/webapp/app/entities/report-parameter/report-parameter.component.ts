...
export class ReportParameterComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reportParameterService
      ...
      .subscribe(
        (res: HttpResponse<IReportParameter[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInReportParameters(): void {
    this.eventSubscriber = this.eventManager.subscribe('reportParameterListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IReportParameter[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/report-parameter'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
